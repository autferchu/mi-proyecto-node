...
test.describe('Empleados - Casos positivos', () => {
  ...
  test('Eliminar un empleado existente', async ({ request }) => {
    ...
    expect(deleteResponse.status()).toBe(200); // o 204, según tu API
...
test.describe('Empleados - Casos negativos al crear', () => {
  ...
  test('Falla con email duplicado', async ({ request }) => {
    ...
    expect(second.status()).toBe(409); // o 400, según tu API
  });
...
test.describe('Empleados - Casos negativos con ID inexistente', () => {
